...
AnalogIn M1_CS(PA_0);
DigitalOut M1_EN(PB_3);
DigitalOut M1_INA(PB_4);
DigitalOut M1_INB(PB_5);
InterruptIn M1_C1(PB_8);
DigitalIn M1_C2(PB_9);
PwmOut M1_PWM(PB_14);

AnalogIn M2_CS(PA_1);
DigitalOut M2_EN(PA_11);
DigitalOut M2_INA(PA_12);
DigitalOut M2_INB(PA_15);
InterruptIn M2_C1(PB_10);
DigitalIn M2_C2(PB_11);
PwmOut M2_PWM(PB_15);
